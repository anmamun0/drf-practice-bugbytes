...
SECRET_KEY = 'django-insecure-$#cnfe)+h!p+6wqa-=4-+q489m96jluo*05a#x0^x*2^pqcr!6'
...
# Using local memory cache for development/testing.
# Redis cache configuration is commented out for now because
